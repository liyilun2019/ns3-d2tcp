...
#ifndef TIME_APP_CHILD
#define TIME_APP_CHILD
 ...
 * of TimeAppChildTxBuffer. Each instance keeps track of the object type to be
 ...
 */
class TimeAppChild : public Application
{
public:
  /**
   ...
   * \param httpServer Pointer to this instance of TimeAppChild, which is where
   *                   the trace originated.
   * \param socket Pointer to the socket where the connection is established.
   */
  typedef void (*ConnectionEstablishedCallback)(Ptr<const TimeAppChild> httpServer,
                                                Ptr<Socket>                   socket);
...
private:
  ...
  Ptr<TimeAppChildTxBuffer>  m_txBuffer;
  ...
  TracedCallback<Ptr<const TimeAppChild>, Ptr<Socket> > m_connectionEstablishedTrace;
 ...
 * be added.
 */
class TimeAppChildTxBuffer : public SimpleRefCount<TimeAppChildTxBuffer>
{
public:
  /// Create an empty instance of transmission buffer.
  TimeAppChildTxBuffer ();
...
}; // end of `class TimeAppChildTxBuffer`


}  // end of `namespace ns3`


#endif /* TIME_APP_CHILD */
